/****** Object:  Stored Procedure InvoiceUpdate - Script Date: Friday, 10 August 2012 ******/
if exists (select * from sysobjects where id = object_id(N'[InvoiceUpdate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
UPDATE [dbo].[Invoices] SET 
	...
	[Invoices].[tax] = @tax,
	[Invoices].[is_downloaded] = @is_downloaded,
	[Invoices].[creation_datetime] = @creation_datetime,
	[Invoices].[local_code] = @local_code,
	[Invoices].[downloaded_datetime] = @downloaded_datetime 
output 
	INSERTED.[invoice_id],
