/****** Object:  Stored Procedure PurchaseOrderGet - Script Date: Friday, 10 August 2012 ******/
if exists (select * from sysobjects where id = object_id(N'[PurchaseOrderGet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [PurchaseOrderGet]
GO
...
CREATE PROCEDURE [PurchaseOrderGet]
