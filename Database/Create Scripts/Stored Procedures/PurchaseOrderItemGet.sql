/****** Object:  Stored Procedure PurchaseOrderItemGet - Script Date: Friday, 10 August 2012 ******/
if exists (select * from sysobjects where id = object_id(N'[PurchaseOrderItemGet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [PurchaseOrderItemGet]
GO
...
CREATE PROCEDURE [PurchaseOrderItemGet]
