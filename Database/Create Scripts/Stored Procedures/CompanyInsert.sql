/****** Object:  Stored Procedure CompanyInsert - Script Date: Friday, 10 August 2012 ******/
if exists (select * from sysobjects where id = object_id(N'[CompanyInsert]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
