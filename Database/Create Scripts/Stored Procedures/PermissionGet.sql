/****** Object:  Stored Procedure PermissionGet - Script Date: Friday, 10 August 2012 ******/
if exists (select * from sysobjects where id = object_id(N'[PermissionGet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [PermissionGet]
GO
