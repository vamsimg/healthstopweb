...
namespace HealthStop.Web.manage.Admins
{    
               ...
               if (IsValid)
               {
                    ...
                    else
                    {
                         try
                         {
                              ...
                              AdminListErrorLabel.Text = "New administrator added successfully. An email has been sent to them detailing how to access Stocktakr.";
                              EmailHelper.AdminAccountCreationEmail(new_admin.email, new_admin.full_name, loggedInAdmin.full_name, role, current_company.name);
                         }
                         catch (Exception ex)
                         {
