<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="Admins.aspx.cs" Inherits="HealthStop.Web.manage.Admins.Admins" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
	...
	<br />
     ...
     <asp:Label ID="AdminListErrorLabel" runat="server" Text="" CssClass="errorMessage" EnableViewState="false"></asp:Label>
	...
	<h4>Select User Type</h4>          
		...
		<asp:RadioButtonList ID="AdminTypeRadioButtonList" runat="server" EnableViewState="false">			
			<asp:ListItem Value="Clerk" Selected="True">Store Clerk (Can lookup products only) </asp:ListItem>
			<asp:ListItem Value="Admin">Admin (Standard User for a Company)</asp:ListItem>			
			<asp:ListItem Value="Owner">Owner (Super user to modify product lists, add Admins, modify company details.)</asp:ListItem>		
		</asp:RadioButtonList>
