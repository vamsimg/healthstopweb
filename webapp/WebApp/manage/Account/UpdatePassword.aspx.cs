...
namespace HealthStop.Web.manage.Account
{
	public partial class UpdatePassword : System.Web.UI.Page
	{
		...
		protected void ChangePasswordButton_Click(object sender, EventArgs e)
		{
			if (IsValid)
			{
				...
				{
                         //LogHelper.LogFailure(loggedInAdmin.admin_id, ex);

					PasswordChangeErrorLabel.Text = "Your password change was unsuccessful. Please email help@stocktakr.com";
				}
			}
		}   
	}
