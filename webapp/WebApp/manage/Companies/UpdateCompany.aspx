<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="UpdateCompany.aspx.cs" Inherits="HealthStop.Web.manage.Companies.UpdateCompany" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">

     <h1>Update Company</h1>

     <asp:Label ID="APIKeyLabel" runat="server" Text=" API Key:" CssClass="leftLabel" ></asp:Label>
		<asp:Label ID="APIKeyFieldLabel" runat="server" CssClass="textField"></asp:Label>
	...
	<div class="brclear"></div>  	
     ...
     <span class="leftLabel">Has a Store POS?</span>
          <asp:CheckBox ID="HasPOSCheckBox" runat="server" CssClass="textField" />
